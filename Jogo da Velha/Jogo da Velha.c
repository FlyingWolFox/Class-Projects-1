...
void gridPrinter(int grid[3][3], int mod)
{
	...
	//modifys the supergrid and print it
	if (mod == 2)
	{
	...
	//prints the grid with 1 to 9 in it
	if (mod == 3)
	{
	...
	//prints the grid with (1,1) to (3,3)
	if (mod == 4)
	{
		printf("\n               ##              ##              \n               ##              ##              \n   /         \\ ##  /      __ \\ ##  /      __ \\ \n  ( /|    /|  )## ( /|     _) )## ( /|    __) )\n   \\ |  /  | / ##  \\ |  / /__/ ##  \\ |  / __)/ \n               ##              ##              \n               ##              ##              \n               ##              ##              \n ##############################################\n               ##              ##              \n               ##              ##              \n   /__       \\ ##  /__    __ \\ ##  /__    __ \\ \n  (  _)   /|  )## (  _)    _) )## (  _)   __) )\n   \\/__ /  | / ##  \\/__ / /__/ ##  \\/__ / __)/ \n               ##              ##              \n               ##              ##              \n               ##              ##              \n ##############################################\n               ##              ##              \n               ##              ##              \n   /__       \\ ##  /__    __ \\ ##  /__    __ \\ \n  ( __)   /|  )## ( __)    _) )## ( __)   __) )\n   \\__) /  | / ##  \\__) / /__/ ##  \\__) / __)/ \n               ##              ##              \n               ##              ##              \n               ##              ##              \n ");
	}
...
int main(int argc, char* argv[])
{
	...
	system("pause");
	printf("1: As posi��es v�o de 1 a 9\n");
	gridPrinter(grid, 3);
	printf("\n2: As posi��es s�o coordenadas to tipo (x,y)\n");
	gridPrinter(grid, 4);
	if (scanf("%i", &insertionPreference) == 1);
	printf("Gostaria de jogar o modo: 1- Singleplyer ou 2- Multiplayer\n");
	if (scanf("%i", &player) == 1);
	gridPrinter(grid, 0);
	printf("Com qual gostaria de jogar? 1-  ou 2- ");
